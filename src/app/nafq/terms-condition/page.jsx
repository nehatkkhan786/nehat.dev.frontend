...
const page = () => {
  return (
    ...
    <br />
    <p>
      These terms and conditions apply to the Nafq app (hereby referred to as "Application") for mobile devices that was created by Abdul Rasid (nehat) (hereby referred to as "Service Provider") as a Free service.
    </p>
    <br />
    <p>
    ...
    <br />
    <p>These terms and conditions are effective as of 2024-08-31</p>
    <br />
