...
const page = () => {
  return (
    ...
    <p>
      This privacy policy applies to the Nafq app (hereby referred to as "Application") for mobile devices
      that was created by Abdul Rasid (nehat) (hereby referred to as "Service Provider") as a Free service.
    ...
    <br />
    <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to connect@nehat.dev. The information that the Service Provider requests will be retained by them and used as described in this privacy policy.</p>
    <br />
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at connect@nehat.dev and they will respond in a reasonable time.</p>
    <br />
    ...
    <br />
    <p>This privacy policy is effective as of 2024-08-31</p>
    <br />
    ...
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at connect@nehat.dev or visit my website <a href='https://nehat.dev'>nehat.dev</a></p>
